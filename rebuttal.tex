...
\textbf{Response:} We've edited this.

\hspace{-0.7cm}Section 1. 

\item \emph{``software systems for the analysis of large volumes of dynamic, distributed, and data intensive have received relatively less soâ'' [data intensive -> frequently accessed data?]}
