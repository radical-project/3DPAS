...
\textbf{Response:} \katznote{attention needed here}. \omernote{Suggestion: perhaps we should remove -- ``usually with some input data needed and some output data produced''}
...
\textbf{Response:} \katznote{attention needed here}
\omernote{Suggestion: this implies that with the evolution of software or hardware infrastructure/environments, the existing algorithm may not function correctly or not execute at all.}
...
\textbf{Response:} \katznote{attention needed here}. \omernote{Suggestion: Yes, this is correct. These are generally support ``components'' that are needed for the application to work correctly.}
